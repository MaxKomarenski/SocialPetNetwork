...
public class SosRequestNotifier implements NotificationInfoShower {
    @Override
    public void show(Context context, RemoteMessage remoteMessage) {
        ...
        notificationLayout.setTextViewText(R.id.notification_description, "Check your lost pet list");
        notificationLayout.setTextViewText(R.id.notification_type_text_view, "!!!SOS!!!");
